            ...
            <g id="Front">
              ...
              <g>
                    <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire"
                          class="st2 st5 st9">{{ expiration || expirationPlaceholder }}</text>
